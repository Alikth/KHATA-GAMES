(() => {
  const characters = [
    ...
    {id:"damon-lannister",name:"Damon Lannister",region:"Westerlands",castle:"Casterly Rock",house:"Lannister",age:40,premium:true,image:"/assets/characters/damon-lannister-300q15.txt",about:"Damon Lannister، لرد ۴۰ ساله‌ی Casterly Rock، از خاندان Lannister و یکی از چهره‌های بانفوذ Westerlands است. او مردی مغرور، حسابگر و آشنا با سیاست دربار است که ثروت و قدرت خاندانش را دو ستون جدایی‌ناپذیر می‌داند. Damon می‌داند که گاهی یک پیمان درست، از یک پیروزی در میدان نبرد ارزشمندتر است."},
    {id:"tytos-brax",name:"Tytos Brax",region:"Westerlands",castle:"Hornvale",house:"Brax",age:34,premium:false,image:"/assets/characters/tytos-brax-300q15.txt",about:"Tytos Brax، لرد ۳۴ ساله‌ی Hornvale، از خاندان Brax در Westerlands فرمان می‌راند. او جنگجویی منضبط و وفادار است که به جای نمایش قدرت، روی آموزش نیروها و استحکام موقعیت خاندانش تمرکز دارد. Tytos می‌داند که در جنگ‌های بزرگ، نظم و زمان‌بندی می‌تواند نتیجه را تعیین کند."},
